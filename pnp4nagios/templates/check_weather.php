...
$def[2] .=  rrd::gprint("temp_f", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
...
$def[3] .=  rrd::gprint("var1", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
$def[3] .=  rrd::line2("var1", "#E80C3E", "Wind direction") ;

$ds_name[4] = "wind_mph";
$ds_name[5] = "wind_gust_mph";
...
$def[4] .=  rrd::gprint("wind_mph", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
$def[4] .=  rrd::gprint("wind_gust_mph", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
$def[4] .=  rrd::line2("wind_mph", "#E80C3E", "Wind speed") ;
$def[4] .=  rrd::line2("wind_gust_mph", "#008000", "Wind gust speed") ;

$ds_name[6] = "pressure_mb";
$opt[5]  = "--vertical-label \"mbar\" -u 1150 -l 960 --title \"Air pressure\" ";
$def[5]  =  rrd::def("pressure_mb", $RRDFILE[1], $DS[6], "AVERAGE") ;
$def[5] .=  rrd::gprint("pressure_mb", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
$def[5] .=  rrd::line2("pressure_mb", "#E80C3E") ;

$ds_name[7] = "dewpoint_c";
$opt[6]  = "--vertical-label \"Degree Celsius\"  --title \"Dewpoint in Celsius\" ";
$def[6]  =  rrd::def("dewpoint_c", $RRDFILE[1], $DS[7], "AVERAGE") ;
$def[6] .=  rrd::gprint("dewpoint_c", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
$def[6] .=  rrd::line2("dewpoint_c", "#E80C3E", "Dewpoint") ;

$ds_name[8] = "dewpoint_f";
$opt[7]  = "--vertical-label \"Degree Fahrenheit\"  --title \"Dewpoint in Fahrenheit\" ";
$def[7]  =  rrd::def("dewpoint_f", $RRDFILE[1], $DS[8], "AVERAGE") ;
$def[7] .=  rrd::gprint("dewpoint_f", array("LAST", "MAX", "AVERAGE"), "%2.1lf $UNIT[1]") ;
$def[7] .=  rrd::line2("dewpoint_f", "#E80C3E", "Dewpoint") ;

$ds_name[9] = "precip_1hr";
$ds_name[10] = "precip_today";
$opt[8]  = "--vertical-label \"cm\"  --title \"Precipitation\" ";
$def[8]  =  rrd::def("precip_1hr", $RRDFILE[1], $DS[9], "LAST") ;
$def[8] .=  rrd::def("precip_today", $RRDFILE[1], $DS[10], "LAST") ;
$def[8] .=  rrd::gprint("precip_1hr", array("LAST"), "%2.1lf $UNIT[1]") ;
$def[8] .=  rrd::gprint("precip_today", array("LAST"), "%2.1lf $UNIT[1]") ;
